#version final final de segmentacion
import os
import cv2
import imghdr
import numpy as np
    ...
    for archivo in archivos:
        ...
        if imghdr.what(ruta_origen) in ['jpeg', 'jpg', 'png']:
            ...
            if imagen is not None:
                ...
                # Convertir la imagen recortada a modo RGBA con fondo transparente
                recortada_rgba = cv2.cvtColor(imagen_recortada, cv2.COLOR_BGR2BGRA)
...
carpeta_origen = "/Users/natty/Desktop/a"
carpeta_destino = "/Users/natty/Desktop/destinopruebita"
